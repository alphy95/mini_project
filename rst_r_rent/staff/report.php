...
<body>
	...
	<div class="special">
		<div class="container">
			...
			<div class="container">
                            <div class="col-lg-8"><table class="table table-bordered table-condensed table-hover">
                        <tr>
                            <td>#</td>
                            <td>Customer Name</td>
                            <td>Contact</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {
                                    ?>
                                <a href="order_item.php?oid=<?php echo $ro[0] ?>"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <?php
                                }
                                else
                                {
                                    ?>
                                <a href="printbill.php?oid=<?php echo $ro[0] ?>"><span class="glyphicon glyphicon-print"></span></a>
                                <?php
                                }
                                ?>
                            </td>
