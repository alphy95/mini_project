			...
			<div class="container"><div class="col-lg-12">
                <div class="col-lg-6">
                    <form method="post">
                        ...
                        <table class="table table-bordered table-condensed">
                            ...
                            <tr>
                                <td>Category</td>
                                <td><select name="itm" class="form-control" onchange="loadcat(this.value)">
                            ...
                            function loadcat(x)
                            {
                                ...
                                xhttp.onreadystatechange = function() {
                                  if (this.readyState == 4 && this.status == 200) {
                                   document.getElementById("it").innerHTML = this.responseText;
                                  }
                                };
                                xhttp.open("GET", "loaditem.php?c="+x, true);
                                xhttp.send();
                            }
                            function loadamt(x)
                            {
                                var a=x.split(",");
                                document.getElementById("amt1").value=a[1];
                            }
                            </script>
                            <tr>
                                <td>Item</td>
                            ...
                            <tr>
                                <td>Rate</td>
                                <td><input type="text" name="amt1" id="amt1" class="form-control"/></td>
                            </tr>
                            <tr>
                                <td>Qty</td>
                            ...
                            <tr>
                            <td colspan="2"><center>
                                <input type="submit" name="add_ordr" value="ADD NOW" class="btn btn-warning" />
                            </center></td>
                        </tr>
                        </table>
                ...
                <div class="col-lg-6">
                    ...
                    <table class="table table-bordered table-condensed table-hover table-responsive">
                        ...
                        <tr>
                            <td colspan="5"><center>
                                <a href="print.php?oid=<?php echo $_GET['oid'] ?>"><div class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-print"></span> Proceed to Bill</div></a>
                        </center>
                            </td>
                        </tr>
                    </table>
