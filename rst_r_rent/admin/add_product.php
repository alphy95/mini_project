...
{
    $cn=$_POST['cn'];
    $ins_cat=mysqli_query($dbcon,"INSERT INTO `category_data`(`id`, `cat_name`) VALUES ('','$cn')");
    if($ins_cat>0)
    {
        header("location:add_product.php?suc=1");
    }
}
if(isset($_POST['add_pro']))
{
    ...
    $amt=$_POST['amt'];
    $up=$_FILES['up']['name'];
    $chk=mysqli_query($dbcon,"select * from item_data");
    $count=mysqli_num_rows($chk);
    $nfn=$count."".substr($up,strrpos($up,"."));
    if(move_uploaded_file($_FILES['up']['tmp_name'],getcwd()."\\item_pic\\$nfn"))
    {
        $ins_itm=mysqli_query($dbcon,"INSERT INTO `item_data`(`id`, `cat_id`, `item_nme`, `amt`, `pic`, `st`) VALUES ('','".$_GET['cat']."','$pn','$amt','$nfn','1')");
        if($ins_itm>0)
        {
            header("location:add_product.php?cat=".$_GET['cat']);
        }
    }
}
?>
	...
	<div class="special">
		<div class="container">
			<div class="wthree-special-heading">
				<h2><b>Manage Category - Product</b></h2>
			</div><br />
			<div class="container">
                        <div class="col-lg-6">
                <form method="post">
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        <td colspan="2"><center>
                            <input type="submit" name="sub" value="OK" class="btn btn-danger" />
                    </center></td> 
                    </tr>
                </table>
                </form>
                ...
                <table class="table table-bordered table-condensed table-responsive">
                    ...
                    <tr>
                        ...
                        <td><a href="add_product.php?cat=<?php echo $rcat[0] ?>"><span class="glyphicon glyphicon-plus-sign"></span></a></td>
                    </tr>
                    <?php
                    }
                    ?>
            ...
            <div class="col-lg-6">
                ...
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        <td colspan="2"><center>
                            <input type="submit" name="add_pro" value="ADD PRODUCT" class="btn btn-danger" />
                    </center></td> 
                    </tr>
                </table>
                    </form>
                <?php
                $sel_itm=mysqli_query($dbcon,"select * from item_data where cat_id='".$_GET['cat']."'");
                ...
                <div class="col-lg-4">
                    <center>
                    <img src="item_pic/<?php echo $ritm[4] ?>" class="img img-responsive" />
                    <b><?php echo $ritm[2] ?></b>
                    </center>
                </div>
                <?php
